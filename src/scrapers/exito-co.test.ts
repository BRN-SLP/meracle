...
import { parseSizeFromName } from "./exito-co.js";

describe("parseSizeFromName (exito-co)", () => {
  ...
  it("treats a bare trailing Kg as 1000 g loose produce", () => {
...
// @coverage: happy-path + edge cases for exito-co
